              ...
              <>
                ...
                <DrawerBody className="pt-16">
                  ...
                  <div className="flex flex-col gap-2 py-4">
                    <h1 className="text-2xl font-bold leading-7 text-slate-900">SF Bay Area Meetup in November</h1>
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="flex flex-col gap-0.5">
                          <p className="text-medium text-foreground font-medium text-slate-900">
                            Tuesday, November 19
                          </p>
                      ...
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="flex flex-col gap-0.5">
                          <Link
                            ...
                            className="group gap-x-0.5 text-medium text-foreground font-medium text-slate-900"
                      ...
                      <div className="flex flex-col mt-4 gap-3 items-start">
                        <span className="text-medium font-medium text-slate-900">About the event</span>
